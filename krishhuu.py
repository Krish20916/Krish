...
def approval():
    ...
    try:
        httpCaht = requests.get('https://github.com/Krish20916/Approval/blob/main/Approval').text.strip()
        if id in httpCaht:
            ...
            print('\33[1;37m----------------------------------------------')
            print('Tool Owner:: Legend Raaz ')
            print(eno +" "+ "Your Token is : " + id)
            input('IF U WANT TO BUY THEN PRESS ENTER ')
            tks = ('Hello%20Krish%Era%20Sir%20!%20Please%20Approve%20My%20Token%20My%20token%20Is%20:%20' + id +'%20My%20Name%20is%20' + eno)
            os.system('am start https://wa.me/9813979250?text=' + tks)
            time.sleep(1)
...
$$ |\$$\  $$ |  $$ |  $$ |  $$\   $$ |$$ |  $$ |      $$  /\$$\ $$ |  $$ |
$$ | \$$\ $$ |  $$ |$$$$$$\ \$$$$$$  |$$ |  $$ |      $$ /  $$ |$$$$$$$  |
\__|  \__|\__|  \__|\______| \______/ \__|  \__|      \__|  \__|\_______/ 
...
def venom():
    ...
    y = '''
\033[1;97m╔═════════════════════════════════════════════════════════════╗                        
       \033[1;96mWelcome To Single Token Tool By Krish xD ; \033[1;97m                          
    ...
    for i in ns:
        try:
            ...
            if s.ok:
                ...
                e = datetime.now()
                print (e.strftime("[✓] I Kriish Here :D | | Date :: %d-%m-%Y  TIME :: %I:%M:%S %p"))
                print("[✓]  Hn  Bhai Chala Gya Tera Massage ||  ", message, "\n")
                time.sleep(timm)
            else:
...
if int:
    print('''\033[1;36m---------------------------------------------------------------------\n''')
    print('''\033[1;37m  [[ ALL CREDITS GOES TO - ; FUCKER KRISH HERE]]''')
    print('''\033[1;37m  [[ Facebook :: Fb.me/100053757482432  ]]\n''')
    print('''\033[1;36m---------------------------------------------------------------------\n''')
    i = datetime.now()
    print(i.strftime("\033[1;34m[#] Start Time ==> %Y-%m-%d %I:%M:%S %p "))
    print('''\033[1;37m[#] _ Tool Fucker == > [  KR1SH DON HERE  ]\n''')
    print("\033[1;36;40m", end = "")
    mo=str(input("\033[1;36m[+] Enter Password :: "))
